...
/**
 * Represents a chat-based Custom Command.
 */
export interface CustomCommand {
	 ...
	 * @param message The message that triggered this command.
	 * @param args The message arguments of the command (seperated by spaces (' ') in an array, this excludes prefix and command/alias itself).
	 * @param procedure The proceuder name to be executed when the command triggered.
	 */
	execute(
		message: Discord.Message & { client: Client },
		args: string[],
...
/**
 * Represents Timed Messages.
 */
export interface TimedMessages {
	/**
	 * The embed message details to start with.
	 */
	embed: {
		title: string;
		message: string;
	...
	/**
	 * The executor method for the timed message.
	 * @param embed The embed message instance.
	 * @param job The cron job instance.
	 */
	execute(
		embed: Discord.EmbedBuilder,
		job: CronJob & { channelID: string }
	): void | Promise<void>;
}
...
export interface Client extends Discord.Client {
	/**
	 * Represents a collection of the settings.
	 */
	settings: Discord.Collection<string, Settings>;
	 ...
	 * Represents a collection of chat-based Message Commands.
	 */
	customCommands: Discord.Collection<string, CustomCommand>;
	...
	/**
	 * Represents a collection of timed messages.
	 */
	timedMessages: Discord.Collection<string, TimedMessages>;
}
